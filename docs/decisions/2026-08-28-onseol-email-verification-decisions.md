...
> **2026-09-08 업데이트**: 이 문서의 "미인증 회원" 모델(결정 2)은 PR #145에서 폐기됐다. 계정은 이제 이메일 인증을 마친 뒤에만 생성되고, 미인증 회원이라는 상태 자체가 존재하지 않는다. 최신 모델은 [[2026-09-08-onseol-signup-redesign-decisions]] 참고.
