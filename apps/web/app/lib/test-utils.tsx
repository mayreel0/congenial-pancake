...
// default, so this is safe to wrap unconditionally. GlobalToast mirrors the
// real root layout — toast.success()/toast.error() calls are now a module-
// level singleton with nothing rendering them unless something in the tree
// mounts this, same as production.
